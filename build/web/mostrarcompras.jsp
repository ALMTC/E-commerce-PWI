<%-- 
    ...
    Created on : 01/09/2021, 01:50:24
    Author     : Notebook
--%>
        ...
        <div id='div_et2' class="mx-auto">
            <div>
                <table>
                    ...
                    <tbody>
                        <%  List<Produto> valores = (List<Produto>) request.getAttribute("valores");
                            Iterator<Produto> iter = valores.iterator();
                        ...
                        <tr>
                            ...
                            <td><%= aux.getQuantidade() * aux.getPreco()%></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
