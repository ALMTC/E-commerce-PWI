 ...
 * @author Notebook
 */
public class SubtrairProdutoCarrinhoCompraServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String novoValor = CarrinhoCompra.subtrairItem(Integer.parseInt(produtoId), 1, cookie.getValue());
