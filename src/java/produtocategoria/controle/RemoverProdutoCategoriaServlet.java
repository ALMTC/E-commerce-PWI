 ...
 * @author Notebook
 */
public class RemoverProdutoCategoriaServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoverProdutoCategoriaServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        RequestDispatcher dispatcher = request.getRequestDispatcher("MostrarProduto?id=" + produtoId);
